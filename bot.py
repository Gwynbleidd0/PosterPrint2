...
def main():
    ...
    #Создание клавиатур
    key_rezka = create_float_keyboard([['А6 105*148','А5 148*210'],['А4 210*297','А3 297*420'],['визитка 5*9','дисконт 54*86'],['карманный календарь 7*10','билет 60*150'],['европолоса 99*210','Другой размер']],True)
